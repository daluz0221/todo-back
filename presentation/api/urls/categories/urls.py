...
from ...views.categories_views import CategoryCreateView, ListCategoriesApiView, UpdteCategoryApiView, DeleteCategoryApiView, GetCategoryApiView
...
urlpatterns = [
    ...
    path('category/<uuid:category_id>', GetCategoryApiView.as_view(), name='get_category_by_id'), # PUT
